...
def distance_order(
    ...
    dist : Union[numpy.ndarray, 'ckmeans.distance.DistanceMatrix']
        ...
        ckmeans.distance.DistanceMatrix object.
    method : str
...
def reorder_distance(
    ...
    method: str = 'GW',
    linkage_type: str = 'average',
) -> Union[numpy.ndarray, 'ckmeans.distance.DistanceMatrix']:
    '''reorder_distance
    ...
    Union[numpy.ndarray, 'ckmeans.distance.DistanceMatrix']
        ...
        ckmeans.distance.DistanceMatrix, depending on the input.
    ...
    if is_ndarray:
        ...
        return ckmeans.distance.DistanceMatrix(
            dist_mat,
