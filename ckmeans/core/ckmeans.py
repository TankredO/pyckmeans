...
class CKmeansResult:
    ...
    * cl: n-length vector of cluster memberships
    ...
    def order(
        ...
        return ckmeans.ordering.distance_order(
            1 - self.cmatrix,
            method=method,
...
class CKmeans:
    ...
    def fit(
        self,
        x: Union[numpy.ndarray, ckmeans.pcoa.PCOAResult],
        ...
        if isinstance(x, ckmeans.pcoa.PCOAResult):
            x = x.vectors
    ...
    def predict(
        ...
        linkage = hierarchy.linkage(
            ckmeans.ordering.condensed_form(1 - cmatrix),
            method=linkage_type,
        )
